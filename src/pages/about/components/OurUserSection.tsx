  ...
  const freelancerTypes = [
    {
      ...
      description:
        "Anyone can join as an ordinary freelancer. Create a profile, get a Smart CV, and showcase skills. Eligible for jobs posted on the platform and can apply for SkillStamp verification to boost credibility.",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Freelancers verified through our SmartStart onboarding. Gain access to curated job opportunities, higher visibility to clients, and comprehensive support with guides, toolkits, and mentorship.",
      icon: CheckCircle,
    ...
    },
    {
      ...
      description:
        "Carefully selected freelancers representing our in-house brand standard. Direct AI matching with clients, priority access to premium projects, and top-tier opportunities through SmartStart service.",
      icon: Crown,
  ...
  const clientTypes = [
    {
      ...
      subtitle: "Post & Hire",
      description:
        "Post jobs on the platform and select from freelancers in the open marketplace. Option to upgrade job posts to Featured Listings for increased visibility and faster responses.",
      icon: Briefcase,
      color: "from-blue-500 to-blue-600",
      features: [
        "Post jobs publicly",
    ...
    },
    {
      ...
      description:
        "Businesses seeking verified freelancers only. Fill out a SmartStart™ request form and receive a curated shortlist of pre-vetted freelancers. Saves time, reduces hiring risks, and ensures project quality.",
      icon: Target,
      color: "from-green-500 to-green-600",
      features: [
    ...
    },
    {
      ...
      description:
        "Clients who sponsor freelancers under our Sponsor-a-Freelancer model. Gain social recognition while accessing motivated, trained freelancers committed to delivering exceptional results.",
      icon: Heart,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 font-medium max-w-4xl mx-auto">
            Workason is built for two main groups of users — Freelancers (supply side) and Clients (demand side).
          </p>
          ...
          {currentData.map((userType) => {
            ...
            return (
              ...
              >
                ...
                {/* Content */}
                <h3 className="text-2xl font-bold text-gray-800 mb-2">{userType.title}</h3>
                <p className="text-lg font-medium text-gray-600 mb-4">{userType.subtitle}</p>
                <p className="text-gray-700 leading-relaxed mb-6">{userType.description}</p>

                {/* Features */}
                <div className="space-y-3 mb-8">
                  {userType.features.map((feature, idx) => (
                    <div key={idx} className="flex items-center gap-3">
                      <div className={`w-5 h-5 bg-gradient-to-r ${userType.color} rounded-full flex items-center justify-center`}>
                ...
                {/* CTA Button with Login Path */}
                <a href={userType.path}>
                  <button
                    className={`w-full bg-gradient-to-r ${userType.color} text-white font-bold py-3 px-6 rounded-xl hover:shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2`}
                  >
                    Get Started
                    <ArrowRight size={16} />
                  </button>
        ...
        <div className="bg-white rounded-3xl p-12 shadow-lg border border-gray-100 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">We’re building a supportive freelancing ecosystem, not just a platform.</p>
            </div>
          </div>
        </div>
