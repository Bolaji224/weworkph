...
const SideNav: React.FC = () => {
  ...
  return (
    <div className=''>
      ...
      <div className={`h-full w-72 bg-white text-white flex flex-col fixed lg:static transition-transform transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
