...
const DisputeResolution: React.FC = () => {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center p-6 min-h-screen bg-white ml-64">
        <div className="bg-white border border-gray-200 shadow-lg rounded-2xl p-12 text-center max-w-lg animate-slide-in">
          ...
          <p className="text-gray-600 mb-4">
            Your report has been sent to our admin team. We'll review your case and contact you within 24-48 hours.
          </p>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" disabled={isSubmitting}
              ...
              {isSubmitting ? <>Processing... <span className="animate-spin border-2 border-white border-t-transparent rounded-full w-5 h-5"></span></> : "Submit Dispute Report"}
            </button>
          </form>
        </div>
      </div>
