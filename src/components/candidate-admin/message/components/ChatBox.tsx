...
const EmployerChatPage: React.FC = () => {
  ...
  return (
    <div className="flex h-[85vh] mt-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
      {/* Sidebar */}
                      ...
                      <div className={`max-w-[70%] ${isOwn ? "order-2" : "order-1"}`}>
                        <div
                          className={`px-4 py-3 rounded-2xl shadow-sm ${
                            isOwn
                              ? "bg-[#ee009d] text-white rounded-br-sm"
